            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-12">
                                <form role="form" method="POST" action="/research">
                                    @csrf
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <textarea class="form-control" rows="3" name="researchName"
                                                placeholder="{{ __('dataTypes.researchNamePlaceHolder') }}" required>{{ old('researchName') }}</textarea>
                                    </div>
                                    ...
                                    <div class="row input-toghter">
                                        ...
                                        <div class="form-group input-group col-lg-6 px-lg-2">
                                            ...
                                            <input type="date" class="form-control" name="publishDate"
                                                required value="{{ old('publishDate') }}">
                                        </div>
                                        ...
                                        <div class="form-group input-group col-lg-6 px-lg-2">
                                            ...
                                            <input type="text" class="form-control" name="publishPlace"
                                                    required value="{{ old('publishPlace') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row input-toghter">
                                        ...
                                        <div class="form-group input-group col-lg-6 px-lg-2">
                                            ...
                                            <input type="number" step="0.001" class="form-control" name="effectCoefficient"
                                                 value="{{ old('effectCoefficient') }}" required>
                                        </div>
                                    ...
                                    <div class="row input-toghter">
                                        <div class="form-group input-group col-lg-6 px-lg-2">
                                            ...
                                            <input type="number" class="form-control" name="participantsBonusValue"
                                                    required value="{{ old('participantsBonusValue') }}" min='1'>
                                            </div>
                                    </div>
